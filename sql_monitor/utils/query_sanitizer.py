...
class QuerySanitizer:
    ...
    def __init__(self, placeholder_prefix: str = "@p", show_examples: bool = True):
        """
        Inicializa o sanitizador.

        Args:
            placeholder_prefix: Prefixo para placeholders (default: @p).
            show_examples: Se True, gera exemplos genéricos dos valores.
        """
