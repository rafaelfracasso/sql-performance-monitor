...
class QueryCache:
    ...
    - Thread-safe com locks internos
    """
        ...
        try:
            with self._lock:
                data = {
                    ...
                    'queries': self.cache.copy()  # Cria cópia para evitar modificação durante serialização
                }

            # Salva fora do lock para não bloquear por I/O
